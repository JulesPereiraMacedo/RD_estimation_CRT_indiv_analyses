...
### We recommand to have a file where you stock every R files of the Simulation 1 and to choose it for the entire Simulation 1
...
# We recommand to create this file in the Base_file
...
list_prev = list(c(0.5,0.5),c(0.2,0.2),c(0.1,0.1))
